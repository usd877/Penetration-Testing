...
Для автоматического тестирования веб-приложения с помощью OWASP ZAP, был использован следующий скрипт на Python, который использует библиотеку `python-owasp-zap-v2.4` для взаимодействия с OWASP ZAP API:
...
# Инициализация ZAP API
zap = ZAPv2(apikey=api_key)

# Запуск сканирования
print(f"Запуск сканирования для {target_url}")
...
for alert in alerts:
    print(f"Уязвимость: {alert['alert']}, Уровень: {alert['risk']}")

### 5.2. Результаты тестирования с OWASP ZAP
```bash
Запуск проверки для: http://92.51.39.106
Проверка...
Статус сканирования: 0%
Статус сканирования: 0%
Статус сканирования: 0%
Статус сканирования: 4%
Статус сканирования: 8%
Статус сканирования: 10%
Статус сканирования: 14%
Статус сканирования: 21%
Статус сканирования: 23%
Статус сканирования: 27%
Статус сканирования: 34%
Статус сканирования: 38%
Статус сканирования: 42%
Статус сканирования: 44%
Статус сканирования: 48%
Статус сканирования: 55%
Статус сканирования: 59%
Статус сканирования: 63%
Статус сканирования: 68%
Статус сканирования: 72%
Статус сканирования: 76%
Статус сканирования: 78%
Статус сканирования: 80%
Статус сканирования: 87%
Статус сканирования: 91%
Статус сканирования: 91%
Статус сканирования: 91%
Статус сканирования: 91%
Статус сканирования: 91%
Статус сканирования: 91%
Статус сканирования: 93%
